...
CREATE TABLE GuestReviews (ReviewId int IDENTITY NOT NULL, FK_Account int NOT NULL, FK_PropertyListing int NOT NULL, Review nvarchar(2000) NOT NULL, RatingScore int NOT NULL, PRIMARY KEY (ReviewId));
...
CREATE TABLE PropertyListing (PropertyId int IDENTITY NOT NULL, FK_Account int NOT NULL, State tinyint NOT NULL, PricePerNight bigint NULL, PricePerMonth bigint NULL, PricePerWeek bigint NULL, Photos nvarchar(2000) NULL, GreatTitle nvarchar(255) NULL, GreatSummary nvarchar(2000) NULL, BedRoom tinyint NOT NULL, Bathroom int NOT NULL, HomeType tinyint NOT NULL, RoomType tinyint NOT NULL, Accommodates tinyint NOT NULL, Address1 nvarchar(50) NULL, Address2 nvarchar(50) NULL, City nvarchar(255) NULL, State2 nvarchar(255) NULL, Zip nvarchar(10) NULL, FK__Country int NOT NULL, Currency int null, Birthday datetime not null, PRIMARY KEY (PropertyId));
CREATE TABLE _Country (id int IDENTITY NOT NULL, IsoCode nvarchar(2) NOT NULL, Name nvarchar(255) NOT NULL, PRIMARY KEY (id));
CREATE TABLE Account (id int IDENTITY NOT NULL, AccountId nvarchar(255) NOT NULL UNIQUE, Login nvarchar(255) NOT NULL UNIQUE, PasswordHash nvarchar(255) NOT NULL, FirstName nvarchar(255) NOT NULL, LastName nvarchar(255) NOT NULL, Email nvarchar(255) NOT NULL, IsEmailConfirmed bit NOT NULL, FK__Country int NOT NULL, FK__Roles tinyint NOT NULL, City nvarchar(255) NULL, Address nvarchar(255) NULL, Mobile nvarchar(15) NULL, Gender tinyint NULL, PostalCode nvarchar(255) NULL, IsValidated bit NOT NULL, PictureUrl nvarchar(255) NULL, Birthday datetime null, PRIMARY KEY (id));
CREATE TABLE DB_Errors_Log 
(
	 DBERRL_ID				BIGINT			IDENTITY(1,1)	NOT NULL	CONSTRAINT PK_DB_Errors_Log_C_ID PRIMARY KEY CLUSTERED
	,DBERRL_DateTime		DATETIME						NOT NULL
	,DBERRL_ErrCode			INT									NULL
	,DBERRL_ErrMsg			NVARCHAR(4000)						NULL
	,DBERRL_Severity		INT									NULL
	,DBERRL_APP				NVARCHAR(128)						NULL
	,DBERRL_Server			NVARCHAR(128)						NULL
	,DBERRL_DB				NVARCHAR(128)						NULL
	,DBERRL_SP				NVARCHAR(128)						NULL
	,DBERRL_USER			NVARCHAR(128)						NULL
	,DBERRL_HOST			NVARCHAR(128)						NULL
	,DBERRL_LineNumber		INT									NULL
	,DBERRL_NativeErrCode	INT									NULL
	,DBERR_InstanceName		NVARCHAR(32)						NULL
