...
CREATE TABLE Account (id int IDENTITY NOT NULL, AccountId nvarchar(255) NOT NULL UNIQUE, PasswordHash nvarchar(255) NOT NULL, FirstName nvarchar(255) NOT NULL, LastName nvarchar(255) NOT NULL, Email nvarchar(255) NOT NULL, IsEmailConfirmed bit NOT NULL, FK__Country int NOT NULL, FK__Roles tinyint NOT NULL, City nvarchar(255) NULL, Address nvarchar(255) NULL, Mobile nvarchar(15) NULL, Gender tinyint NULL, PostalCode nvarchar(255) NULL, Language int NULL, IsValidated bit NOT NULL, ImageSourceId nvarchar(255) NULL, PRIMARY KEY (id));
