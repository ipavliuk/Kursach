...
CREATE TABLE PropertyListing (PropertyId int IDENTITY NOT NULL, FK_Account int NOT NULL, State tinyint NOT NULL, PricePerNight bigint NULL, PricePerMonth bigint NULL, PricePerWeek bigint NULL, Photos nvarchar(2000) NULL, GreatTitle nvarchar(40) NULL, GreatSummary nvarchar(255) NULL, BedRoom tinyint NOT NULL, Bathroom int NOT NULL, HomeType tinyint NOT NULL, RoomType tinyint NOT NULL, Accommodates tinyint NOT NULL, Address1 nvarchar(50) NULL, Address2 nvarchar(50) NULL, City nvarchar(255) NULL, State2 nvarchar(255) NULL, Zip nvarchar(10) NULL, FK__Country int NOT NULL, Currency int null, Birthday datetime not null, PRIMARY KEY (PropertyId));
